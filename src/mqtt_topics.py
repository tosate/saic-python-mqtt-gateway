...
DRIVETRAIN_TOTAL_BATTERY_CAPACITY_SET = (
    DRIVETRAIN_TOTAL_BATTERY_CAPACITY + "/" + SET_SUFFIX
)
...
ACCOUNT = "account"
ACCOUNT_GATEWAY_VERSION = ACCOUNT + "/gatewayVersion"
ACCOUNT_USER_TIMEZONE = ACCOUNT + "/timezone"
ACCOUNT_REFRESH_INTERVAL = ACCOUNT + "/refreshInterval"
ACCOUNT_LAST_REFRESH = ACCOUNT + "/lastRefresh"
ACCOUNT_LAST_LOGIN = ACCOUNT + "/lastLogin"
ACCOUNT_LAST_LOGIN_ERROR = ACCOUNT + "/lastLoginError"
...
REFRESH_POLLING_PHASE = REFRESH + "/pollingPhase"
